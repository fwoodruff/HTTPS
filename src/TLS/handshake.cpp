...
tls_record key_schedule::server_certificate_record( bool use_tls13) const{
...
tls_record key_schedule::server_hello_record(bool use_tls13, std::optional<std::array<unsigned char, 32UL>> client_session_id, bool can_heartbeat ) const {
...
tls_record key_schedule::server_key_exchange_record(std::array<uint8_t, 32> pubkey_ephem) const {
...
void key_schedule::hello_extensions(tls_record& record, bool use_tls13, bool can_heartbeat) const {
...
std::pair<bool, tls_record> key_schedule::client_heartbeat_record(tls_record record, bool can_heartbeat) {
    if(!can_heartbeat) {
